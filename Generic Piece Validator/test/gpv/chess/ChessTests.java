...
class ChessPieceTests {
    ...
    static Stream<Arguments> pieceMoveProvider() {
        return Stream.of(
                ...
                Arguments.of(true, makeCoordinate(1, 2), makeCoordinate(3, 3),
                        WHITEKNIGHT),
                Arguments.of(true, makeCoordinate(3, 1), makeCoordinate(3, 4),
                        WHITEKNIGHT),
                ...
                Arguments.of(true, makeCoordinate(1, 3), makeCoordinate(2, 2),
                        WHITEBISHOP),
                Arguments.of(true, makeCoordinate(1, 3), makeCoordinate(4, 2),
                        WHITEBISHOP),
    ...
    static Stream<Arguments> captureMoveProvider() {
        return Stream.of(
                ...
                Arguments.of(true, makeCoordinate(1, 3), makeCoordinate(2, 2),
                        WHITEBISHOP),
                Arguments.of(true, makeCoordinate(1, 2), makeCoordinate(7, 1),
                        WHITEROOK),
