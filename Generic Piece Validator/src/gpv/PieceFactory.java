...
/**
 * <p>
 * The PieceFactory produces pieces of various types. To get a piece the client must get
 * the instance and invoke the makePiece method. <br/>
 * For example the client code might look like this: <code>
 ...
 *            the type of piece
 * @param <D>
 *            a descriptor of the piece subtype
 */
